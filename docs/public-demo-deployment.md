...
- Automatic deployment from the GitHub `main` branch after CI checks pass.
...
- Release automation: Render GitHub credentials connected; deploys trigger only after GitHub Actions succeeds
